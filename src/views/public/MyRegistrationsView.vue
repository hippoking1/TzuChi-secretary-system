        ...
        >
          <div class="flex-1">
            ...
            <div class="text-xs text-muted flex flex-col gap-1">
              ...
              <div>👤 <strong>報名人：</strong>{{ r.name || r.guestName }} <span v-if="r.identityType || r.volunteerRole">（{{ r.identityType || r.volunteerRole }}）</span> | 👥 <strong>報名人數：</strong>{{ r.participantCount || 1 }} 位</div>
            </div>
          </div>
